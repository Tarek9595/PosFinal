  ...
  return (
    <div className="w-full min-h-screen overflow-y-auto bg-[#F8FAFC] flex flex-col items-center p-6.5 gap-4">
      <form
        ...
        className="w-full max-w-112.5 bg-white rounded-3xl p-10 shadow-[0px_20px_50px_rgba(0,0,0,0.05)] flex flex-col items-center gap-8"
      >
        ...
        <div className="w-full space-y-5 mb-8">
          <div className="flex flex-col gap-2">
            <label className="text-[#00BC7D] text-[12px] font-bold tracking-widest uppercase">
              Staff ID
            </label>
            <div className="relative">
              <input
                ...
                className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl py-4.5 px-5 outline-none shadow-inner"
              />
          ...
          <div className="flex flex-col gap-2">
            ...
            {formik.touched.pin && formik.errors.pin && (
              <span className="text-red-500 text-xs">{formik.errors.pin}</span>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col w-full">
          <button
            type="submit"
            className="w-full bg-[#00BC7D] text-white font-bold py-5 rounded-2xl mb-6  cursor-pointer"
          >
            Sign In
          </button>
          <button className="text-[#94A3B8] text-[13px] font-medium hover:text-[#45556C] transition-colors">
